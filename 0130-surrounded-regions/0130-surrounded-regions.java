//intuition :- All the Os connected with Os at the boundary of the matrix cannot be converted to X . So find Os at the boundary and do a dfs traversal for the same.
class Solution {
